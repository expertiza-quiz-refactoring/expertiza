...
describe QuizQuestion do
  ...
  describe "complete" do
    context "when the question is a multiple-choice radio" do
      it "contains the text of the question within a textarea tag" do
        expect(@radio_question.complete(0).htmlsafe).to include("In which city is NCSU located?</textarea>")
      end

      it "contains each of the choices" do
        expect(@radio_question.complete(0)).to include("Raleigh")
        expect(@radio_question.complete(0)).to include("Atlanta")
        expect(@radio_question.complete(0)).to include("Charlotte")
        expect(@radio_question.complete(0)).to include("North Carolina")
      end

      it "puts each choice in a radio button" do
        expect(@radio_question.complete(0).scan('input type="radio"').size).to eq(4)
      end

      it "selects only the correct answer" do
        expect(@radio_question.complete(0)).to include('value="1" checked="checked"')
      end

      it "does not select the incorrect answers" do
        expect(@radio_question.complete(0)).to include('value="2" />')
        expect(@radio_question.complete(0)).to include('value="3" />')
        expect(@radio_question.complete(0)).to include('value="4" />')
      end
    end

    context "when the question is a multiple-choice checkbox" do
      it "contains the text of the question within a textarea tag" do
        expect(@checkbox_question.complete(0)).to include("Which of the following are colors?</textarea>")
      end

      it "contains each of the choices" do
        expect(@checkbox_question.complete(0)).to include("Paint")
        expect(@checkbox_question.complete(0)).to include("Blue")
        expect(@checkbox_question.complete(0)).to include("Car")
        expect(@checkbox_question.complete(0)).to include("Red")
      end

      it "puts each choice in a check box" do
        expect(@checkbox_question.complete(0).scan('input type="checkbox"').size).to eq(4)
      end

      it "checks only the correct answers" do
        expect(@checkbox_question.complete(0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_2_iscorrect" value="1" checked="checked"')
        expect(@checkbox_question.complete(0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_4_iscorrect" value="1" checked="checked"')
      end

      it "does not check the incorrect answers" do
        expect(@checkbox_question.complete(0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_1_iscorrect" value="1" />')
        expect(@checkbox_question.complete(0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_3_iscorrect" value="1" />')
      end
    end

    context "when the question is true/false" do
      it "contains the text of the question within a textarea tag" do
        expect(@true_false_question.complete(0)).to include("2+2=4</textarea>")
      end

      it "contains each of the choices" do
        expect(@true_false_question.complete(0)).to include("True")
        expect(@true_false_question.complete(0)).to include("False")
      end

      it "puts each choice in a radio button" do
        expect(@true_false_question.complete(0).scan('input type="radio"').size).to eq(2)
      end

      it "selects only the correct answer" do
        expect(@true_false_question.complete(0)).to include('value="True" checked="checked"')
      end

      it "does not select the incorrect answer" do
        expect(@true_false_question.complete(0)).to include('value="False" />')
      end
    end
  end
  ...
  describe "view_completed_question" do
    context "when the question is a multiple-choice radio" do
      it "contains the text of the question within a textarea tag" do
        expect(@radio_question.view_completed_question(0,0).htmlsafe).to include("In which city is NCSU located?</textarea>")
      end

      it "contains each of the choices" do
        expect(@radio_question.view_completed_question(0,0)).to include("Raleigh")
        expect(@radio_question.view_completed_question(0,0)).to include("Atlanta")
        expect(@radio_question.view_completed_question(0,0)).to include("Charlotte")
        expect(@radio_question.view_completed_question(0,0)).to include("North Carolina")
      end

      it "puts each choice in a radio button" do
        expect(@radio_question.view_completed_question(0,0).scan('input type="radio"').size).to eq(4)
      end

      it "selects only the correct answer" do
        expect(@radio_question.view_completed_question(0,0)).to include('value="1" checked="checked"')
      end

      it "does not select the incorrect answers" do
        expect(@radio_question.view_completed_question(0,0)).to include('value="2" />')
        expect(@radio_question.view_completed_question(0,0)).to include('value="3" />')
        expect(@radio_question.view_completed_question(0,0)).to include('value="4" />')
      end
    end

    context "when the question is a multiple-choice checkbox" do
      it "contains the text of the question within a textarea tag" do
        expect(@checkbox_question.view_completed_question(0,0)).to include("Which of the following are colors?</textarea>")
      end

      it "contains each of the choices" do
        expect(@checkbox_question.view_completed_question(0,0)).to include("Paint")
        expect(@checkbox_question.view_completed_question(0,0)).to include("Blue")
        expect(@checkbox_question.view_completed_question(0,0)).to include("Car")
        expect(@checkbox_question.view_completed_question(0,0)).to include("Red")
      end

      it "puts each choice in a check box" do
        expect(@checkbox_question.view_completed_question(0,0).scan('input type="checkbox"').size).to eq(4)
      end

      it "checks only the correct answers" do
        expect(@checkbox_question.view_completed_question(0,0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_2_iscorrect" value="1" checked="checked"')
        expect(@checkbox_question.view_completed_question(0,0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_4_iscorrect" value="1" checked="checked"')
      end

      it "does not check the incorrect answers" do
        expect(@checkbox_question.view_completed_question(0,0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_1_iscorrect" value="1" />')
        expect(@checkbox_question.view_completed_question(0,0)).to include('id="quiz_question_choices_2_MultipleChoiceCheckbox_3_iscorrect" value="1" />')
      end
    end

    context "when the question is true/false" do
      it "contains the text of the question within a textarea tag" do
        expect(@true_false_question.view_completed_question(0,0)).to include("2+2=4</textarea>")
      end

      it "contains each of the choices" do
        expect(@true_false_question.view_completed_question(0,0)).to include("True")
        expect(@true_false_question.view_completed_question(0,0)).to include("False")
      end

      it "puts each choice in a radio button" do
        expect(@true_false_question.view_completed_question(0,0).scan('input type="radio"').size).to eq(2)
      end

=begin
      it "selects only the correct answer" do
        expect(@true_false_question.view_completed_question(0,0)).to include('value="True" checked="checked"')
      end
=end

      it "does not select the incorrect answer" do
        expect(@true_false_question.view_completed_question(0,0)).to include('value="False" />')
      end
    end
  end
end